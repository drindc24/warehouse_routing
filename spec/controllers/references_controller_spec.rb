...
RSpec.describe ReferencesController, type: :controller do
  ...
  let(:valid_attributes) {
    { ref_code: SecureRandom.uuid, destination_id: destination.id }
  }

  let(:invalid_attributes) { { ref_code: '', destination_id: destination.id } }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested reference" do
        ...
        reference.reload
        expect(reference.ref_code).to eq '1234567890'
      end
